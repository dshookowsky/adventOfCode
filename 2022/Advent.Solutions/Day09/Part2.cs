...
public class Part2
{
    ...
    public static int Solution(IEnumerable<string> lines)
    {
    ...
    private class State
    {
        ...
        public Dictionary<Point, int> PointHistory { get; set; } = new ()
        {
            { new Point(0, 0), 1 }
        };
